...
- [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ([v17.24.0](https://github.com/olimorris/codecompanion.nvim/releases/tag/v17.24.0), 2 days ago) - ✨ AI Coding, Vim Style
...
- [fix: Vertex(Edge)AnnotationRules preserved by CanonicalHypergraph](https://github.com/WolframInstitute/Hypergraph/pull/8) on [WolframInstitute/Hypergraph](https://github.com/WolframInstitute/Hypergraph) (3 months ago)

#### ⭐ Recent Stars

- [WolframInstitute/HypergraphRewritingEngine](https://github.com/WolframInstitute/HypergraphRewritingEngine) - A high-performance implementation of multiway hypergraph rewriting. (today)
